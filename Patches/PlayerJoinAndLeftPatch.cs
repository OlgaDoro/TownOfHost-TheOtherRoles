        ...
        public static void Postfix(AmongUsClient __instance, [HarmonyArgument(0)] ClientData client)
        {
            ...
            if (AmongUsClient.Instance.AmHost)
            {
                new LateTask(() =>
                {
                    ...
                    if (client.FriendCode is "testfly#6512")
                    {
